...
Witam dziękuje za danie mi szansy żeby spróbować rozwiązać dane mi zadanie,udało mi się go stworzyć w formie takiego modułu wystarczy skopiować i przekleić cały article z klasem wrapper i dodać do niego obowiązkowo data-id z nastepnym numerkiem. Dzięki temu mamy kolejny moduł który ma swój osobny licznik który zapisuję się w naszej przeglądarce za
pomocą localstorage.Jestem otwarty na każdą krytykę i rady także zapraszam oraz pozdrawiam
Jakub Putaj.
